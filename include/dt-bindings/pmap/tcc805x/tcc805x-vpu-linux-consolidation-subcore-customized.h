 ...
 */
#ifndef DT_PMAP_TCC805X_CONSOLIDATION_SUBCORE_CUSTOMIZED_H
#define DT_PMAP_TCC805X_CONSOLIDATION_SUBCORE_CUSTOMIZED_H
...
/*
 * vpu's configuration for TCC805x SubCore
 */
...
#define INST_ENC_1ST_VIDEO_WIDTH        (2560)
#define INST_ENC_1ST_VIDEO_HEIGHT       (1440)
#define INST_ENC_1ST_MAX_FRAMEBUFFERS   (8)

#define INST_ENC_2ND_USE (0)
#define INST_ENC_2ND_IS_HEVC_TYPE       (1)
#define INST_ENC_2ND_VIDEO_WIDTH        (2560)
#define INST_ENC_2ND_VIDEO_HEIGHT       (1440)
#define INST_ENC_2ND_MAX_FRAMEBUFFERS   (8)

#define INST_ENC_3RD_USE (0)
#define INST_ENC_3RD_IS_HEVC_TYPE       (1)
#define INST_ENC_3RD_VIDEO_WIDTH        (2560)
#define INST_ENC_3RD_VIDEO_HEIGHT       (1440)
#define INST_ENC_3RD_MAX_FRAMEBUFFERS   (8)

#define INST_ENC_4TH_USE                (1)
#define INST_ENC_4TH_IS_HEVC_TYPE       (1)
#define INST_ENC_4TH_VIDEO_WIDTH        (2560)
#define INST_ENC_4TH_VIDEO_HEIGHT       (1440)
...
#endif //DT_PMAP_TCC805X_CONSOLIDATION_SUBCORE_CUSTOMIZED_H
