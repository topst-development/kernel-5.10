 ...
 */
#ifndef DT_PMAP_TCC803X_ANDROID_CUSTOMIZED_H
#define DT_PMAP_TCC803X_ANDROID_CUSTOMIZED_H
...
#define CONFIG_SUPPORT_TCC_WAVE410_HEVC
 ...
 *                  1 means to set to HEVC (please put the defconfig
 *                  file to "CONFIG_SUPPORT_TCC_HEVC_4K=y")
...
#else
#define INST_1ST_MAX_FRAMEBUFFERS       (14)
#endif
...
#endif //DT_PMAP_TCC803X_ANDROID_CUSTOMIZED_H
