...
*/
#define CODEC_HANDLE_T
#define CODEC_RESULT_T
#define CODEC_ADDR_T
#define INC_DEVICE_TREE_PMAP // for build vpu common header working on device tree
//#define TEST_VPU_DRAM_INTLV
//#define PMAP_TO_CMA


/*
 * [20211214] Temporary fix because followings are used
...
#if defined(JPU_C5)
#include <dt-bindings/pmap/common/TCC_JPU_CODEC.h> //JPU C5
#else
#include <dt-bindings/pmap/common/TCC_JPU_C6.h> //JPU C6
#endif
#endif

#if defined(SUPPORT_TYPE_C5)
#include <dt-bindings/pmap/common/TCC_VPUs_CODEC.h> // VPU video codec
#else
#include <dt-bindings/pmap/common/TCC_VPU_CODEC.h> // CODA960 or BODA950
#if defined(ARCH_TCC803X_LINUX) || defined(ARCH_TCC803X_ANDROID) || \
	defined(ARCH_TCC805X_LINUX) || defined(ARCH_TCC805X_ANDROID) || \
	defined(ARCH_TCC807X_LINUX) || defined(ARCH_TCC807X_ANDROID)
#include <dt-bindings/pmap/common/TCC_VPU_C7_CODEC.h>
...
#include <dt-bindings/pmap/common/TCC_VPU_D6.h>
#endif
#endif

#ifdef CONFIG_SUPPORT_TCC_WAVE410_HEVC
#include <dt-bindings/pmap/common/TCC_HEVC_CODEC.h> //WAVE410
#endif

#ifdef CONFIG_SUPPORT_TCC_G2V2_VP9
#include <dt-bindings/pmap/common/TCC_VP9_CODEC.h>
#endif

#ifdef CONFIG_SUPPORT_TCC_WAVE512_4K_D2
#include <dt-bindings/pmap/common/TCC_VPU_4K_D2_CODEC.h> //WAVE512
#endif

#if defined(CONFIG_SUPPORT_TCC_WAVE420L_VPU_HEVC_ENC) || defined(CONFIG_SUPPORT_TCC_WAVE420L_2ND_VPU_HEVC_ENC)
#include <dt-bindings/pmap/common/TCC_VPU_HEVC_ENC_CODEC.h> //WAVE420L
#endif

#if defined(CONFIG_SUPPORT_TCC_VPU)
#define VPU_WORK_BUF_SIZE        (WORK_CODE_PARA_BUF_SIZE)
#else
#define VPU_WORK_BUF_SIZE        (0)
#endif
...
#define VPU_HEVC_ENC_WORK_BUF_SIZE (VPU_HEVC_ENC_WORK_CODE_BUF_SIZE * 2)
#else
#define VPU_HEVC_ENC_WORK_BUF_SIZE (VPU_HEVC_ENC_WORK_CODE_BUF_SIZE)
#endif
#elif defined(CONFIG_SUPPORT_TCC_WAVE420L_2ND_VPU_HEVC_ENC)
#define VPU_HEVC_ENC_WORK_BUF_SIZE (VPU_HEVC_ENC_WORK_CODE_BUF_SIZE)
#else
...
#define VPU_ENC_HEADER_BUF_SIZE (VPU_HEVC_ENC_HEADER_BUF_SIZE)
#else
#define VPU_ENC_HEADER_BUF_SIZE (VPU_ENC_PUT_HEADER_SIZE)
#endif
#else
#define VPU_ENC_HEADER_BUF_SIZE (0)
#endif
...
#define PMAP_SIZE_ENC                (ENC_SIZE)
#define SIZE_VIDEO                   (VIDEO_MAIN_SIZE)
...
#endif//DT_BINDINGS_PMAP_VPU_MEM_SIZE_H
