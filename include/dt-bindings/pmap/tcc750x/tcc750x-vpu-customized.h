 ...
 * completely
 */
#define ARCH_TCC750X_LINUX


/*
 * vpu's configuration for TCC750x
 */
...
#define INST_ENC_1ST_VIDEO_HEIGHT       (2048)
...
#define INST_ENC_2ND_VIDEO_HEIGHT       (2048)
...
#endif //DT_PMAP_TCC750X_CUSTOMIZED_H
