...
#define CLK_RESTORE_BY_SUBCORE	(1UL << 26UL)	/* Clocks will restored by Sub-Cluster.
						 *
						 * DO NOT APPLY THIS FLAGS TO SMU SUBSYSTEM
						 *
						 * This flag only for using dedicated
						 * Subsystem. And need to be used carefully.
						 *
						 * You MUST apply this flag to whole clock
						 * devices in target subsystem.
						 */
#define CLK_IS_PCLKDCO		(1UL << 27UL)
#define CLK_F_SKIP_SSCG		(1UL << 28UL)	/* Nor working now */
...
#define TC_CLK_F_SRC(x)		(((x) & CLK_F_SRC_CLK_MASK) | CLK_F_FIXED)
