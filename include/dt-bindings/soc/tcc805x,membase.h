...
#ifndef DT_BINDINGS_TCC805X_MEMBASE_H
#define DT_BINDINGS_TCC805X_MEMBASE_H

/*
 * Default size for EVB: 8GiB (Max: 16GiB for TCC8050/3, 8GiB for TCC8059)
...
#endif /* DT_BINDINGS_TCC805X_MEMBASE_H */
