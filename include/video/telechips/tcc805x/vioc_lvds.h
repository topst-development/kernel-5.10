 ...
 */
#define SHIFT_SDC 0U /* SDM bypass configuration */
#define SHIFT_SRC 1U /* SRVC bypass configuration */
#define SHIFT_SDB 2U /* SDM bypass status */
#define SHIFT_SRB 3U /* SRVC bypass status */
#define SHIFT_SDO 4U /* SDM bypass OTP */
#define SHIFT_SRO 5U /* SRVC bypass OTP */
...
extern void LVDS_WRAP_SM_Bypass(unsigned int lcdc_mux_id, unsigned int en);
