...
/* VIOC Subcore Interrupt sources */
#define VIOC0_SUB_IRQI			(84U)
#define VIOC1_SUB_IRQI			(85U)
#define VIOC2_SUB_IRQI			(86U)
#define VIOC3_SUB_IRQI			(87U)
#define VIOC_SUB_IRQ_MAX		(0x4U)
