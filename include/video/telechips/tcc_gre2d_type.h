...
typedef struct{
	...
	unsigned char uv_order;  //UV_order 0: uv  1:vu it is use
} G2D_FMT_CTRL;
...
// operator 0/1 chroma-key source select
typedef enum {
	CHROMA_OP0_NOOP = 0, // [OP0] disable
	CHROMA_OP1_NOOP = 0, // [OP1] disable
	CHROMA_S0 = 1,       // [OP0] src0 & S0_chroam
	CHROMA_OP0 = 1,      // [OP1] op0 & S0_chroam
	CHROMA_S1 = 2,       // [OP0] src1 & S1_chroma
	CHROMA_OP1 = 2,      // [OP1] op0 & S1_chroma
	CHROMA_RESEVE = 3,   // [OP0] reseved
	CHROMA_S2 = 3,       // [OP1] src2 & S2_chroma
} G2D_OP_CHROMA;
...
typedef struct {
	G2D_OP_CHROMA csel0;  //operator 0 chroma-key source select 0:disable 1: op0 & S0_chroam 2:op0 & S1_chroma 3:src2 & S2_chroma
	G2D_OP_CHROMA csel1;  //operator 1 chroma-key source select 0:disable 1: op0 & S0_chroam 2:op0 & S1_chroma 3:src2 & S2_chroma
