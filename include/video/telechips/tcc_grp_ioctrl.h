 ...
 */
#ifndef TCC_GRP_IOCTRL_H
#define TCC_GRP_IOCTRL_H
...
typedef struct {
	...
	G2D_OP_MODE  ch_mode; //G2D_OP_MODE
	G2D_OP_MODE  parallel_ch_mode;
} G2D_COMMON_TYPE;
...
typedef struct {
	...
	unsigned short alpha_value;
} G2D_BITBLIT_TYPE_1;


#endif // TCC_GRP_IOCTRL_H
