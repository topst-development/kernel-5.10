...
#define AFBCDEC_S1_BASE						(0xC0U)
#define AFBCDEC_S2_BASE						(0x140U)
#define AFBCDEC_S3_BASE						(0x1C0U)
...
#define AFBCDEC_S_BUFFER_WIDTH				(0x0CU)
#define AFBCDEC_S_BUFFER_HEIGHT				(0x10U)
#define AFBCDEC_S_BOUNDING_BOX_X_START		(0x14U)
#define AFBCDEC_S_BOUNDING_BOX_X_END		(0x18U)
#define AFBCDEC_S_BOUNDING_BOX_Y_START		(0x1CU)
#define AFBCDEC_S_BOUNDING_BOX_Y_END		(0x20U)
#define AFBCDEC_S_OUTPUT_BUF_ADDR_LOW		(0x24U)
#define AFBCDEC_S_OUTPUT_BUF_ADDR_HIGH		(0x28U)
#define AFBCDEC_S_OUTPUT_BUF_STRIDE			(0x2CU)
#define AFBCDEC_S_PREFETCH_CFG				(0x30U)
#define AFBCDEC_S_PAYLOAD_MIN_LOW			(0x34U)
#define AFBCDEC_S_PAYLOAD_MIN_HIGH			(0x38U)
#define AFBCDEC_S_PAYLOAD_MAX_LOW			(0x3CU)
#define AFBCDEC_S_PAYLOAD_MAX_HIGH			(0x40U)
 ...
 */
#define AFBCDEC_IRQ_SECURE_ID_ERR_SHIFT		(5U)
#define AFBCDEC_IRQ_AXI_ERR_SHIFT			(4U)
...
#define AFBCDEC_IRQ_SECURE_ID_ERR_MASK \
		((u32)0x1U << AFBCDEC_IRQ_SECURE_ID_ERR_SHIFT)
#define AFBCDEC_IRQ_AXI_ERR_MASK \
		((u32)0x1U << AFBCDEC_IRQ_AXI_ERR_SHIFT)
...
#define AFBCDEC_IRQ_ALL \
	(AFBCDEC_IRQ_SECURE_ID_ERR_MASK \
	|AFBCDEC_IRQ_AXI_ERR_MASK \
...
/*
 * Header Buffer Low Register Information
 */
#define AFBCDEC_HEADERBUF_ADDR_LOW_SHIFT		(0U)

#define AFBCDEC_HEADERBUF_ADDR_LOW_MASK \
			((u32)0xFFFFFFC0U << AFBCDEC_HEADERBUF_ADDR_LOW_SHIFT) 
			//Bits [5:0] must be set to 0 for alignment requirements

/*
 * Header Buffer High Register Information
 */
 ...
 */
#define AFBCDEC_MODE_PAYLOAD_LIMIT_SIHFT	(19U)
#define AFBCDEC_MODE_TILED_HEADER_SHIFT	(18U)
...
#define AFBCDEC_MODE_PAYLOAD_LIMIT_MASK	((u32)0x1U << AFBCDEC_MODE_PAYLOAD_LIMIT_SIHFT)
#define AFBCDEC_MODE_TILED_HEADER_MASK		((u32)0x1U << AFBCDEC_MODE_TILED_HEADER_SHIFT)
#define AFBCDEC_MODE_SUPERBLK_MASK	((u32)0x3U << AFBCDEC_MODE_SUPERBLK_SHIFT)
...
/*
 * Image Width Register Information
 */
#define AFBCDEC_SIZE_WIDTH_SHIFT	(0U)

#define AFBCDEC_SIZE_WIDTH_MASK		((u32)0x3FFFU << AFBCDEC_SIZE_WIDTH_SHIFT)

/*
 * Image Height Register Information
 */
#define AFBCDEC_SIZE_HEIGHT_SHIFT	(0U)

#define AFBCDEC_SIZE_HEIGHT_MASK	((u32)0x3FFFU << AFBCDEC_SIZE_HEIGHT_SHIFT)

/*
 * Bounding box x start Register Information
 */
#define AFBCDEC_BOUNDING_BOX_X_START_SHIFT	(0U)

#define AFBCDEC_BOUNDING_BOX_X_START_MASK ((u32)0x1FFFU << AFBCDEC_BOUNDING_BOX_X_START_SHIFT)

/*
 * Bounding box x end Register Information
 */
#define AFBCDEC_BOUNDING_BOX_X_END_SHIFT	(0U)

#define AFBCDEC_BOUNDING_BOX_X_END_MASK ((u32)0x1FFFU << AFBCDEC_BOUNDING_BOX_X_END_SHIFT)

/*
 * Bounding box y start Register Information
 */
#define AFBCDEC_BOUNDING_BOX_Y_START_SHIFT	(0U)

#define AFBCDEC_BOUNDING_BOX_Y_START_MASK ((u32)0x1FFFU << AFBCDEC_BOUNDING_BOX_Y_START_SHIFT)

/*
 * Bounding box y end Register Information
 */
#define AFBCDEC_BOUNDING_BOX_Y_END_SHIFT	(0U)

#define AFBCDEC_BOUNDING_BOX_Y_END_MASK ((u32)0x1FFFU << AFBCDEC_BOUNDING_BOX_Y_END_SHIFT)

/*
 * Output Buffer Low Register Information
 */
#define AFBCDEC_OUTBUF_ADDR_LOW_SHIFT		(0U)

#define AFBCDEC_OUTBUF_ADDR_LOW_MASK \
	((u32)0xFFFFFF80U << AFBCDEC_OUTBUF_ADDR_LOW_SHIFT)
//Bits [6:0] must be set to 0 for alignment requirements.

/*
 * Output Buffer High Register Information
 */
...
/*
 * Output Buffer Stride Register Information
 */
#define AFBCDEC_OUTBUF_STRIDE_SHIFT		(0U)

#define AFBCDEC_OUTBUF_STRIDE_MASK \
	((u32)0xFF8FU << AFBCDEC_OUTBUF_STRIDE_SHIFT)
//Bits [6:0] must be set to 0 for alignment requirements
...
/*
 * Payload Min Low Register Information
 */
#define AFBCDEC_PAYLOAD_MIN_LOW_SHIFT		(0U)

#define AFBCDEC_PAYLOAD_MIN_LOW_MASK \
	((u32)0xFFFFFFFFU << AFBCDEC_PAYLOAD_MIN_LOW_SHIFT)

/*
 * Payload Min High Register Information
 */
#define AFBCDEC_PAYLOAD_MIN_HIGH_SHIFT		(0U)

#define AFBCDEC_PAYLOAD_MIN_HIGH_MASK \
	((u32)0xFFFFU << AFBCDEC_PAYLOAD_MIN_HIGH_SHIFT)

/*
 * Payload Max Low Register Information
 */
#define AFBCDEC_PAYLOAD_MAX_LOW_SHIFT		(0U)

#define AFBCDEC_PAYLOAD_MAX_LOW_MASK \
	((u32)0xFFFFFFFFU << AFBCDEC_PAYLOAD_MAX_LOW_SHIFT)

/*
 * Payload Max High Register Information
 */
#define AFBCDEC_PAYLOAD_MAX_HIGH_SHIFT		(0U)

#define AFBCDEC_PAYLOAD_MAX_HIGH_MASK \
	((u32)0xFFFFU << AFBCDEC_PAYLOAD_MAX_HIGH_SHIFT)
...
extern void VIOC_AFBCDec_SetYUVTransEnable(
	void __iomem *reg, unsigned int enable);
extern void VIOC_AFBCDec_SetPaylodeLimitEnable(
	void __iomem *reg, unsigned int enable);
extern void VIOC_AFBCDec_SetTiledHeaderEnable(
	void __iomem *reg, unsigned int enable);
