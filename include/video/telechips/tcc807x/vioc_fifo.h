...
extern void VIOC_FIFO_ConfigEntry(
	void __iomem *reg, const unsigned int *buf);
extern void VIOC_FIFO_ConfigDMA(
	void __iomem *reg,
	unsigned int nWDMA, unsigned int nRDMA0,
	unsigned int nRDMA1, unsigned int nRDMA2);
extern void VIOC_FIFO_SetEnable(
	void __iomem *reg,
	unsigned int nWDMA, unsigned int nRDMA0,
	unsigned int nRDMA1, unsigned int nRDMA2);
extern void VIOC_FIFO_CH1_ConfigEntry(void __iomem * pFIFO, unsigned int * buf);
extern void VIOC_FIFO_CH1_ConfigDMA(void __iomem * reg,
	unsigned int nWDMA, unsigned int nRDMA0, unsigned int nRDMA1, unsigned int nRDMA2);
extern void VIOC_FIFO_CH1_SetEnable(void __iomem * pFIFO,
	unsigned int nWDMA, unsigned int nRDMA0, unsigned int nRDMA1, unsigned int nRDMA2);
extern void __iomem *VIOC_FIFO_GetAddress(
