...
#ifndef VPU_CODEC_HANDLE_T_
#define VPU_CODEC_HANDLE_T_
...
#endif
#ifndef VPU_CODEC_RESULT_T_
#define VPU_CODEC_RESULT_T_
typedef int codec_result_t;         //!< return value
#endif
#ifndef VPU_CODEC_ADDR_T_
#define VPU_CODEC_ADDR_T_
#if defined(CONFIG_ARM64)
...
#define GET_INITIAL_INFO_KERNEL_FOR_STREAMING_MODE_ONLY	\
				(VPU_BASE_OP_KERNEL + \
