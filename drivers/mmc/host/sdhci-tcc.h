...
#define TCC897X_SDHC_HOSTCFG_CD(x)	((unsigned int)1 << (28u + (x)))
#define TCC897X_SDHC_HOSTCFG_WP(x)	((unsigned int)1 << (24u + (x)))
...
#define TCC897X_SDHC_DELAY_CON(x)	\
	(TCC897X_SDHC_DELAY_OFFSET + ((x/2u) * 0x4u))
...
#define TCC897X_SDHC_DELAY_CON_DEF		(TCC897X_SDHC_IPTAP((u16)0) \
	| TCC897X_SDHC_IPTAP_EN((u16)0) \
	| TCC897X_SDHC_TUNE_CNT((u16)15) \
	| TCC897X_SDHC_DELAY_CTRL((u16)0)	\
	| TCC897X_SDHC_FBEN((u16)1))
...
#define TCC_SDHC_VENDOR			0x78u
  #define VENDOR_GATE_SDCLK_EN		(1u << 1u)
  #define VENDOR_ENHANCED_STROBE	(1u << 0u)
#define TCC_SDHC_VENDOR_DAT_DLY(x)	((x) & 0x3u << 12)
#define TCC_SDHC_VENDOR_CMD_DLY(x)	((x) & 0x3u << 8)
...
#define TCC_SDHC_64BIT_DMA (1u << 25u)
...
#define TCC_QUIRK_64BIT_DMA (1U << 1)
