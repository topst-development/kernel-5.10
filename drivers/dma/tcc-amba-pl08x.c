...
bool tcc_pl08x_filter_id(struct dma_chan *chan, void *chan_id)
{
	struct pl08x_dma_chan *plchan;
	char *name = chan_id;
...
EXPORT_SYMBOL_GPL(tcc_pl08x_filter_id);
...
MODULE_DESCRIPTION("Telechips UDMA driver");
MODULE_LICENSE("GPL");
