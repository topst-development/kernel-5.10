...
void vmgr_hevc_enc_enable_clock(vmgr_clock_t* vmgr_clk, int vbus_no_ctrl)
{
...
void vmgr_hevc_enc_disable_clock(vmgr_clock_t* vmgr_clk, int vbus_no_ctrl)
{
...
void vmgr_hevc_enc_get_clock(vmgr_clock_t* vmgr_clk, struct device_node *node)
{
	if (node == NULL)
	{
...
void vmgr_hevc_enc_put_clock(vmgr_clock_t* vmgr_clk)
{
	if (vmgr_clk->vpu_clk[FBUS_CHEVCENC_CLK] != NULL)
	{
...
void vmgr_hevc_enc_change_clock(vmgr_clock_t* vmgr_clk, unsigned int width, unsigned int height)
{
...
void vmgr_hevc_enc_get_reset(vmgr_clock_t* vmgr_clk, struct device_node *node)
{
...
void vmgr_hevc_enc_put_reset(vmgr_clock_t* vmgr_clk)
{
#if defined(VIDEO_IP_DIRECT_RESET_CTRL)
...
int vmgr_hevc_enc_get_reset_register(vmgr_clock_t* vmgr_clk)
{
...
void vmgr_hevc_enc_hw_assert(vmgr_clock_t* vmgr_clk)
{
#if defined(VIDEO_IP_DIRECT_RESET_CTRL)
...
void vmgr_hevc_enc_hw_deassert(vmgr_clock_t* vmgr_clk)
{
#if defined(VIDEO_IP_DIRECT_RESET_CTRL)
	V_DBG(VPU_DBG_RSTCLK, "enter");
...
void vmgr_hevc_enc_hw_reset(vmgr_clock_t* vmgr_clk)
{
#if defined(VIDEO_IP_DIRECT_RESET_CTRL)
	V_DBG(VPU_DBG_RSTCLK, "enter");
...
void vmgr_hevc_enc_restore_clock(vmgr_clock_t* vmgr_clk, int vbus_no_ctrl, int opened_cnt)
{
