...
void vmgr_hevc_enc_get_clock(struct device_node *pnode)
{
	if (pnode == NULL) {
...
void vmgr_hevc_enc_get_reset(struct device_node *pnode)
{
#if defined(VIDEO_IP_DIRECT_RESET_CTRL)
	if (pnode == NULL) {
...
void vmgr_hevc_enc_status_clear(const unsigned int *base_addr)
{
#if defined(VPU_C5)
