...
#define OP_EN_CTRL              (ictc_base+0x0U)
#define OP_MODE_CTRL            (ictc_base+0x4U)
#define IRQ_CTRL                (ictc_base+0x8U)
#define T_OUT                   (ictc_base+0xcU)
#define R_EDGE                  (ictc_base+0x10U)
#define F_EDGE                  (ictc_base+0x14U)
#define PRD_CMP_RND             (ictc_base+0x18U)
#define DUTY_CMP_RND            (ictc_base+0x1cU)
#define CNT_EDGE_MAT            (ictc_base+0x20U)
#define CNT_PRE_PRD             (ictc_base+0x30U)
#define OLD_CNT_PRE_PRD         (ictc_base+0x34U)
#define CNT_PRE_DUTY            (ictc_base+0x38U)
#define OLD_CNT_PRE_DUTY        (ictc_base+0x3cU)
#define CUR_EDGE_CNT            (ictc_base+0x40U)
#define PRV_EDGE_CNT            (ictc_base+0x44U)
#define R_EDGE_TSTMP_CNT        (ictc_base+0x48U)
#define F_EDGE_TSTMP_CNT        (ictc_base+0x4cU)
...
static void ictc_configure(void)
{
    ...
    ictc_writel(ictc_prop_v[T_OUT_V], T_OUT);
