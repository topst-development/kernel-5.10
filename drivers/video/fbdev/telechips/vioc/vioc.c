...
static int __init vioc_init(void)
{
	...
	gre2d_init();
#endif
#ifdef CONFIG_VIOC_OUTPUT_CONFIG
	vioc_outputconfig_init();
#endif
	...
	vioc_afbc_dec_init();
#endif
#ifdef CONFIG_VIOC_PVRIC_FBDC
	vioc_pvric_fbdc_init();
#endif

#if defined(CONFIG_ARCH_TCC897X) || defined(CONFIG_ARCH_TCC803X) || defined(CONFIG_ARCH_TCC805X)
	vioc_lvds_init();
#endif
