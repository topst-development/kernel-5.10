...
static struct max96712_prv_data max96712_prv_data_list[] = {
	...
	{
		.name = "fhd_ar0239_2ch",
		.init = max96712_reg_init_fhd_ar0239_2ch,
		.init_size = ARRAY_SIZE(max96712_reg_init_fhd_ar0239_2ch),
		.s_stream = max96712_reg_s_stream,
		.s_stream_size = ARRAY_SIZE(max96712_reg_s_stream),
	},
	{
		.name = "fhd_3ch",
		.init = max96712_reg_init_fhd_3ch,
		.init_size = ARRAY_SIZE(max96712_reg_init_fhd_3ch),
		.s_stream = max96712_reg_s_stream,
		.s_stream_size = ARRAY_SIZE(max96712_reg_s_stream),
	},
	{
		.name = "qhd_ar0820_1ch",
		.init = max96712_reg_init_qhd_ar0820_1ch,
		.init_size = ARRAY_SIZE(max96712_reg_init_qhd_ar0820_1ch),
		.s_stream = max96712_reg_s_stream,
		.s_stream_size = ARRAY_SIZE(max96712_reg_s_stream),
