...
#include "../../../tcc-mipi-csi2/807x/tcc-mipi-csi2-cfg-reg.h"
...
#define CTL_ISP_SOFT_RESET_SHIFT		((uint32_t)4U)
#define CTL_MEM_SHARE_EN0_SHIFT			((uint32_t)8U)
#define CTL_MEM_SHARE_EN1_SHIFT			((uint32_t)9U)
#define CTL_ISP_APB_SOFT_RESET_SHIFT		((uint32_t)12U)
...
#define TCC_ISP_MCU_ATI_I2C_CMD			((uint32_t)0x1C10U)
