...
#ifndef VIN_WRAP_VIN_H
#define	VIN_WRAP_VIN_H
...
#define VIN_WRAP_VIN0			(0x1000U)
#define VIN_WRAP_VIN1			(0x1001U)
#define VIN_WRAP_VIN2			(0x1002U)
#define VIN_WRAP_VIN3			(0x1003U)
...
/* VIN WRAPPER VIN irqs */
enum vin_wrap_vin_intr_src {
	VIN_WRAP_VIN_INTR_UPD = 0,
	VIN_WRAP_VIN_INTR_EOF,
	VIN_WRAP_VIN_INTR_VS,
	VIN_WRAP_VIN_INTR_INVS,
	VIN_WRAP_VIN_INTR_MAX
};
#define VIN_WRAP_VIN_INT_ENABLE			(((u32)1U << VIN_WRAP_VIN_INTR_MAX) - 1U)
#define VIN_WRAP_VIN_INT_MASK			0xCU
...
#define VIN_LUT_K_C_VALUE_4K_PLUS_3_MASK		((u32)0xFFU << VIN_LUT_K_C_VALUE_4K_PLUS_3_SHIFT)
#define VIN_LUT_K_C_VALUE_4K_PLUS_2_MASK		((u32)0xFFU << VIN_LUT_K_C_VALUE_4K_PLUS_2_SHIFT)
#define VIN_LUT_K_C_VALUE_4K_PLUS_1_MASK		((u32)0xFFU << VIN_LUT_K_C_VALUE_4K_PLUS_1_SHIFT)
#define VIN_LUT_K_C_VALUE_4K_PLUS_0_MASK		((u32)0xFFU << VIN_LUT_K_C_VALUE_4K_PLUS_0_SHIFT)

/* Interface APIs. */
void VIN_WRAP_VIN_SetUVSwap(void __iomem *reg, unsigned int uv_swap);
void VIN_WRAP_VIN_SetSyncPolarity(void __iomem *reg,
...
void VIN_WRAP_VIN_SetCtrl(void __iomem *reg,
	unsigned int conv_en, unsigned int hsde_connect_en,
	unsigned int vs_mask, unsigned int fmt, unsigned int data_order);
void VIN_WRAP_VIN_SetInterlaceMode(void __iomem *reg,
	unsigned int intl_en, unsigned int intpl_en);
void VIN_WRAP_VIN_SetCaptureModeEnable(
	void __iomem *reg, unsigned int cap_en);
void VIN_WRAP_VIN_SetFrameSkipNumber(void __iomem *reg,
	unsigned int skip);
void VIN_WRAP_VIN_SetEnable(void __iomem *reg,
	unsigned int vin_en);
void VIN_WRAP_VIN_SetImageSize(void __iomem *reg,
	unsigned int width, unsigned int height);
void VIN_WRAP_VIN_SetImageOffset(void __iomem *reg,
	unsigned int offs_width, unsigned int offs_height,
	unsigned int offs_height_intl);
void VIN_WRAP_VIN_SetImageCropSize(void __iomem *reg,
	unsigned int width, unsigned int height);
void VIN_WRAP_VIN_SetImageCropOffset(void __iomem *reg,
	unsigned int offs_width, unsigned int offs_height);
void VIN_WRAP_VIN_SetY2RMode(void __iomem *reg,
	unsigned int y2r_mode);
void VIN_WRAP_VIN_SetY2REnable(void __iomem *reg,
	unsigned int y2r_en);
void VIN_WRAP_VIN_SetLUT(void __iomem *reg,
	const unsigned int *pLUT);
void VIN_WRAP_VIN_SetLUTEnable(void __iomem *reg,
	unsigned int lut0_en, unsigned int lut1_en, unsigned int lut2_en);
unsigned int VIN_WRAP_VIN_IsEnable(const void __iomem *reg);

void VIN_WRAP_VIN_SetSEEnable(void __iomem *reg,
	unsigned int se);
void VIN_WRAP_VIN_SetFlushBufferEnable(
	void __iomem *reg, unsigned int fvs);
void VIN_WRAP_VIN_SetIreqMask(void __iomem *reg,
	unsigned int mask, unsigned int set);
void VIN_WRAP_VIN_GetStatus(const void __iomem *reg,
	unsigned int *status);
