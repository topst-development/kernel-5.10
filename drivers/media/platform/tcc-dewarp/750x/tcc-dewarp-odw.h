...
#define DEWARP_COLOR_FMT_YUYV			(3U)
#define	DEWARP_COLOR_FMT_YVYU			(4U)
#define	DEWARP_COLOR_FMT_UYVY			(5U)
#define	DEWARP_COLOR_FMT_VYUY			(6U)
...
extern void dewarp_odw_set_output_address(u32 id, u32 addresses[], u32 ir_enable, u32 is_dewarp);
extern void dewarp_odw_set_output_stride(u32 id, u32 strides[], u32 is_dewarp);
...
extern int dewarp_odw_init(void);
#endif /*DEWARP_ODW_H*/