...
static struct tc_divider tc_divider_list[20] = {
	{.id = PLL_0_DIV,		.name = "pll-0-div"},
	{.id = PLL_1_DIV,		.name = "pll-1-div"},
	{.id = PLL_2_DIV,		.name = "pll-2-div"},
	{.id = PLL_3_DIV,		.name = "pll-3-div"},
	{.id = PLL_4_DIV,		.name = "pll-4-div"},
	{.id = PLL_DP_DIV_0,		.name = "pll-dp-div-0"},
	{.id = PLL_DP_DIV_1,		.name = "pll-dp-div-1"},
	{.id = PLL_DP_DIV_2,		.name = "pll-dp-div-2"},
	{.id = PLL_VIDEO_0_DIV_0,	.name = "pll-video-0-div-0"},
	{.id = PLL_VIDEO_0_DIV_1,	.name = "pll-video-0-div-1"},
	{.id = PLL_VIDEO_1_DIV_0,	.name = "pll-video-1-div-0"},
	{.id = PLL_VIDEO_1_DIV_1,	.name = "pll-video-1-div-1"},
	{.id = PLL_AUDIO_0_DIV,		.name = "pll-audio-0-div"},
	{.id = PLL_AUDIO_1_DIV,		.name = "pll-audio-1-div"},
	{.id = PLL_CAM_DIV_0,		.name = "pll-cam-div-0"},
	{.id = PLL_CAM_DIV_1,		.name = "pll-cam-div-1"},
	{.id = PLL_CAM_DIV_2,		.name = "pll-cam-div-2"},
	{.id = PLL_CAM_DIV_3,		.name = "pll-cam-div-3"},
	{.id = PLL_CAM_DIV_4,		.name = "pll-cam-div-4"},
	{.id = PLL_NPU_DIV,		.name = "pll-npu-div"},
};
