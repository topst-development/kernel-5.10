...
static struct tc_divider tc_divider_list[11] = {
	{.id = PLL_0_DIV,		.name = "pll_0_div",		.flags = 0U},
	{.id = PLL_1_DIV,		.name = "pll_1_div",		.flags = 0U},
	{.id = PLL_2_DIV,		.name = "pll_2_div",		.flags = 0U},
	{.id = PLL_3_DIV,		.name = "pll_3_div",		.flags = 0U},
	{.id = PLL_4_DIV,		.name = "pll_4_div",		.flags = 0U},
	{.id = OSC_XIN_DIV,		.name = "osc_xin_div",		.flags = 0U},
	{.id = OSC_XTIN_DIV,		.name = "osc_xtin_div",		.flags = 0U},
	{.id = PLL_VIDEO_0_DIV_0,	.name = "pll_video_0_div_0",	.flags = 0U},
	{.id = PLL_VIDEO_0_DIV_1,	.name = "pll_video_0_div_1",	.flags = 0U},
	{.id = PLL_VIDEO_1_DIV_0,	.name = "pll_video_1_div_0",	.flags = 0U},
	{.id = PLL_VIDEO_1_DIV_1,	.name = "pll_video_1_div_1",	.flags = 0U},
};
