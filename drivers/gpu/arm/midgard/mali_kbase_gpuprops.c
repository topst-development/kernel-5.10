...
/*
 *
 * (C) COPYRIGHT 2017-2023 Telechips Inc.
 ...
 */
	{
		u32 chip_name = get_chip_name();
		if (chip_name == 0x8030 || chip_name == 0x8031 || chip_name == 0x8032 ||
			 chip_name == 0x8035 || chip_name == 0x8037)	// MP3
