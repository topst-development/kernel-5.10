...
#if 0 //DEBUG
#define spdif_writel(v, c, o) \
({if (o == TCC_SPDIF_TX_VERSION_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [TxVersion, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_TX_CONFIG_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [TxConfig, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_TX_CHSTAT_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [TxChStat, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_TX_INTMASK_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [TxIntMask, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_TX_INTSTAT_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [TxIntStat, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_TX_USERDATA_BUF_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [UserData, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_TX_CHSTAT_BUF_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [ChStatus, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_TX_SAMPLEDATA_BUF_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [TxBuffer, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIFTX_DMACFG_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [DMACFG, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_RX_VER_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [RxVersion, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_RX_CONFIG_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [RxConfig, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_RX_SIGSTAT_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [RxStatus, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_RX_INTMASK_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [RxIntMask, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_RX_INTSTAT_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [RxIntStat, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_RX_PHASEDET_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [RxPhase, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_RX_CAP_CHCTRL_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [RxCapCtl, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_RX_CAP_CHSTAT_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [RxCap, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else if (o == TCC_SPDIF_RX_BUF_OFFSET) { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [RxBuffer, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } else { \
	pr_info("<ASoC> SPDIF_REG(0x%px) = 0x%08x [UnKnown, %s]\n", \
		c+o, (unsigned int)v, __func__); \
 } writel(v, c+o); })
#else
#define spdif_writel(v, c, o) \
